...
public interface LedgerLineRepository extends BaseRepository<LedgerLine, Integer> {
    ...
    @Query("SELECT sum(a.fcdebit-a.fccredit) as balance FROM LedgerLine as a WHERE a.account.accountid LIKE :accountid% AND a.transdate<=:todate")
    Double findBalanceFcByAccountByDate(@Param("accountid") String accountid, @Param("todate") Date todate);
    ...
    Double findAccountBalance(@Param("accountNo") String accountNo, @Param("toDate") Date toDate);
        ...
        @Query("SELECT SUM(line.fcdebit-line.fccredit) FROM LedgerLine AS line "
            + "WHERE line.transdate<=:toDate "
            + "AND line.account.accountid LIKE :accountNo")
    Double findAccountBalanceFc(@Param("accountNo") String accountNo, @Param("toDate") Date toDate);
    ...
    Double findAccountBalance(@Param("accountNo") String accountNo, @Param("fromDate") Date fromDate, @Param("toDate") Date toDate);
        ...
        @Query("SELECT SUM(line.fcdebit-line.fccredit) FROM LedgerLine AS line "
            + "WHERE line.transdate>=:fromDate AND line.transdate<=:toDate "
            + "AND line.account.accountid LIKE :accountNo")
    Double findAccountBalanceFc(@Param("accountNo") String accountNo, @Param("fromDate") Date fromDate, @Param("toDate") Date toDate);
    ...
    @Query("SELECT SUM(line.fcdebit), SUM(line.fccredit) FROM LedgerLine AS line "
            + "WHERE line.transdate<=:toDate "
            + "AND line.account.accountid LIKE :accountNo")
    List<Double[]> findAccountBalanceDrCrFc(@Param("accountNo") String accountNo, @Param("toDate") Date toDate);
    ...
    @Query("SELECT SUM(line.fcdebit), SUM(line.fccredit) FROM LedgerLine AS line "
            + "WHERE line.transdate>=:fromDate AND line.transdate<=:toDate "
            + "AND line.account.accountid LIKE :accountNo")
    List<Double[]> findAccountBalanceDrCrFc(@Param("accountNo") String accountNo, @Param("fromDate") Date fromDate, @Param("toDate") Date toDate);
}
